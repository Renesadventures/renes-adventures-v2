...
export async function POST(req: NextRequest) {
  ...
  const userPrompt = userName
    ? `Analyze this photo and create the story package. The guest's name is "${userName}" — use their name as the hero of the story (not Captain René). Captain René is the guide, the guest is the star.`
    : 'Analyze this photo and create the story package.';
