        ...
        <div className="grid md:grid-cols-3 gap-8 mb-16">
          ...
          >
            <div className="relative aspect-video overflow-hidden rounded-t-xl">
              <img
                src="https://www.genspark.ai/api/files/s/oEPWxNGp"
          ...
          >
            <div className="relative aspect-video overflow-hidden rounded-t-xl">
              <img
                src="https://www.genspark.ai/api/files/s/fwWIvuHm"
          ...
          >
            <div className="relative aspect-video overflow-hidden rounded-t-xl">
              <img
                src="https://www.genspark.ai/api/files/s/ELiN1JlV"
                      ...
                      {!previewUrl ? (
                        ...
                        <div className="space-y-3">
                          <div className="aspect-video w-full overflow-hidden rounded-lg border border-white/10 bg-black/40">
                            <img src={previewUrl} alt="Selected upload" className="w-full h-full object-cover" />
                          </div>
