...
async function renderPoster(
  ...
  ctx.fillText('AI-Generated Legend', pad + 24, H - 90);
...
export default function FishStoryCreator() {
  ...
  const generate = async () => {
    ...
    try {
      ...
      try {
        const posterUrl = await renderPoster(previewUrl, generated);
          ...
          <div className="grid grid-cols-1 gap-0 lg:grid-cols-[55%_45%]">
            ...
            <div className="p-6 sm:p-10">
              ...
              <p className="mt-2 text-sm sm:text-base text-slate-700">
                Upload your photo. Our AI creates an epic story, cinematic narration, and an Instagram-ready poster — instantly.
              </p>
              ...
              <div className="mt-8 grid grid-cols-1 gap-4">
                <div className="rounded-3xl bg-white/70 p-5 ring-1 ring-amber-500/25">
                  <div className="flex items-center justify-between">
                    ...
                    {isReal && (
                      <div className="inline-flex items-center gap-1.5 rounded-full bg-emerald-500/10 px-2.5 py-1 text-[10px] font-semibold text-emerald-700 ring-1 ring-emerald-500/20">
            ...
            <div className="border-t border-black/5 lg:border-t-0 lg:border-l border-black/5 bg-white/60 p-6 sm:p-10">
                  ...
                  <div className="relative aspect-[4/5]">
                    {previewUrl ? (
                      ...
                      <>
                        <Image
                          src={placeholderSrc}
                          alt="Angler holding mahi-mahi on boat"
                          fill
                          unoptimized
                          sizes="(min-width: 1024px) 45vw, 100vw"
                          className="object-cover"
                        ...
                        <div className="absolute inset-0 grid place-items-center bg-black/35">
                          <div className="text-center">
                            ...
                            <div className="mt-1 text-xs text-white/80">Your poster preview appears here</div>
                          </div>
                        </div>
                      </>
                    )}
                    ...
                    <div className="absolute inset-x-5 bottom-24">
                      <div className="rounded-2xl bg-black/55 p-4 ring-1 ring-white/15 backdrop-blur-sm">
                        ...
                        <div className="mt-3 text-sm leading-relaxed text-white/90">
                          {displayStory.story.slice(0, 120)}…
                        </div>
                        <div className="mt-4 text-xs font-semibold text-white/70">1080×1350 • Instagram Ready</div>
                      </div>
                    </div>
                  </div>
                </div>
              ...
              <div className="mt-6 rounded-2xl bg-white/70 p-4 ring-1 ring-black/10">
                ...
                <div className="mt-2 text-sm text-slate-700">
                  Upload a photo, our AI analyzes it, generates your epic story, creates a poster, and narrates it in Captain René&apos;s voice. Download and share everywhere.
                </div>
              </div>
              ...
              <div className="mt-6 rounded-2xl bg-amber-500/10 p-4 ring-1 ring-amber-500/20">
                <div className="flex items-center gap-2">
                  ...
                  <span className="text-sm font-semibold text-slate-900">AI Story Engine — Live</span>
                </div>
                <div className="mt-2 text-sm text-slate-700">
                  Powered by GPT-4o Vision for photo analysis and storytelling. ElevenLabs for cinematic voice narration.
                  Every story is unique to your photo.
                </div>
                <div className="mt-3 flex flex-wrap gap-2">
                  <span className="inline-flex items-center rounded-full bg-white px-3 py-1 text-[10px] font-semibold text-slate-700 ring-1 ring-black/10">
                    GPT-4o Vision
                  </span>
                  <span className="inline-flex items-center rounded-full bg-white px-3 py-1 text-[10px] font-semibold text-slate-700 ring-1 ring-black/10">
                    ElevenLabs v2
