...
// ── Auth API route ─────────────────────────────────────────────────────────
const authRoute = `import { NextRequest, NextResponse } from 'next/server';
...
// ── Invoice create API route ───────────────────────────────────────────────
const createRoute = `import { NextRequest, NextResponse } from 'next/server';
...
// ── Write all files ─────────────────────────────────────────────────────────
const adminDir = path.join(process.cwd(), 'src', 'app', 'admin', 'invoice');
const authDir = path.join(process.cwd(), 'src', 'app', 'api', 'invoice', 'auth');
const createDir = path.join(process.cwd(), 'src', 'app', 'api', 'invoice', 'create');
...
fs.writeFileSync(path.join(authDir, 'route.ts'), authRoute, 'utf8');
fs.writeFileSync(path.join(createDir, 'route.ts'), createRoute, 'utf8');

console.log('✓ src/app/admin/invoice/page.tsx');
console.log('✓ src/app/api/invoice/auth/route.ts');
console.log('✓ src/app/api/invoice/create/route.ts');
console.log('\nDone. Add ADMIN_PASSWORD to .env.local and Vercel env vars.');
